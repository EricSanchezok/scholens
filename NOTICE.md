...
Scholens is a modified work based on
[Open Paper](https://github.com/khoj-ai/openpaper), which was received under the
GNU Affero General Public License, version 3. Scholens-specific modifications
are recorded in this repository beginning in July 2026 and are distributed
under the same license; see [LICENSE](./LICENSE).

Copyright in the upstream work and in later modifications remains with the
