...
- [ADR 0050: Contextual Workspace navigation](./0050-contextual-workspace-navigation.md)
- [ADR 0051: Passage-level hybrid retrieval and explicit tool outcomes](./0051-passage-level-hybrid-retrieval-and-tool-outcomes.md)
