...
| [`scholens-job-contracts`](./scholens_job_contracts/README.md) | `scholens_job_contracts` | Server, Jobs      | Queue names and service-neutral completion timing contracts    |
